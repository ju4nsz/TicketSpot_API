...
public class PeliculaController {
    ...
    @PostMapping("/crear")
    public ResponseEntity<PeliculaDto> crearPelicula(@RequestBody @Valid PeliculaDto peliculaDto){
        return ResponseEntity.ok(peliculaInService.crearPelicula(peliculaDto));
    }
